...
def review_image_brand_fit(
    ...
    if product_uri:
        prompt = (
            ...
            "first — same type, color, materials, key design and the product's DISTINCTIVE features "
            "(shape, proportions, patterns, hardware, text/logos). FAIL if the product is missing or "
            "not clearly visible, is a different product, or differs in type, color, materials or any "
            "distinctive feature; also FAIL on garbled text, distortions, unsafe content, or "
