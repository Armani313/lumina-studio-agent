...
consultant_agent = LlmAgent(
    ...
    instruction=(
        ...
        "Pricing (so you can guide budget): a flat $10 base package = 16 images + 2 videos + 2 "
        "cards; beyond it +$1/extra image, +$3/extra video, +$2/extra card; below it −$3/video and "
        "−$2/card removed (all 16 images always included), $5 minimum.\n"
