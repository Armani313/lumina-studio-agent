...
card_production_agent = LlmAgent(
    ...
    instruction=(
        ...
        "card_count cards (default 2 if no spec; if card_count is 0, call no tools and reply with an "
        "empty JSON array []), passing aspect_ratio = the spec's card_aspect_ratio "
